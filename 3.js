...
products.forEach(product => {
  product.price *= 0.85; // Уменьшаем цену каждого продукта на 15%
});

// После выполнения метода forEach, цены продуктов в массиве products будут изменены
console.log(products); // Выводим измененный массив products
